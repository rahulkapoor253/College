...
import static com.skeleton.retrofit.ApiInterface.IMAGE_TEXT_ACCESS;
...
//    Call<LoginResponse> login(@FieldMap HashMap<String, String> map);
    ...
    @GET(LIST_ITEMS)
    Call<Example> getListData();

    @GET(IMAGE_TEXT_ACCESS)
    Call<Example> getImageText(@Header(AUTHORIZATION) String mAccessToken);
